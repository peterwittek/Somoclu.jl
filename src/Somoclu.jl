...
function train(data::Array{Float32, 2}, nSomX, nSomY; nEpoch=10, radius0=0, radiusN=1, radiusCooling="linear", scale0=0.1, scaleN=0.01, scaleCooling="linear", kernelType=0, mapType="planar", gridType="square", compact_support=false, gaussian=true)
    ...
    codebook[1, 1] = 1000
    codebook[2, 1] = 2000
    uMatrix, bmus = train!(codebook, data, nSomX, nSomY; nEpoch, radius0, radiusN, radiusCooling, scale0, scaleN, scaleCooling, kernelType, mapType, gridType, compact_support, gaussian)
    return codebook, uMatrix, bmus
end

function train!(codebook::Array{Float32, 2}, data::Array{Float32, 2}, nSomX, nSomY; nEpoch=10, radius0=0, radiusN=1, radiusCooling="linear", scale0=0.1, scaleN=0.01, scaleCooling="linear", kernelType=0, mapType="planar", gridType="square", compact_support=false, gaussian=true)
